...
# Geometric Parallel MP
GEOMETRIC_PARALLEL_LABEL: str = "Geometric Parallel MP"
GEOMETRIC_PARALLEL_STRATEGY_TAG: str = f"{GEOMETRIC_PARALLEL_LABEL}_strategy"
GEOMETRIC_PARALLEL_ANALYSIS_TAG: str = f"{GEOMETRIC_PARALLEL_LABEL}_analysis"

# Geometric Parallel MP+CUDA
GEOMETRIC_CUDA_LABEL: str = "Geometric Parallel MP+CUDA"
GEOMETRIC_CUDA_STRATEGY_TAG: str = f"{GEOMETRIC_PARALLEL_LABEL}_strategy"
GEOMETRIC_CUDA_ANALYSIS_TAG: str = f"{GEOMETRIC_PARALLEL_LABEL}_analysis"